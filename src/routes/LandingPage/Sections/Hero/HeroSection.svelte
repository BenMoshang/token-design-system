...
<section class="hero" aria-label="Hero Section">
	...
	<div class="hero__content">
		...
		<p class="util__stack hero__available">
			...
			<span class="util__text--secondary">AVAILABLE,</span>
			<mark class="util__text--primary">{heroText.available}</mark>
		</p>
		...
		<p class="util__stack hero__remote-work">
			...
			<span class="util__text--secondary">WEB DEVELOPMENT</span>
			<mark class="util__text--primary">{heroText.Work}</mark>
		</p>
	</div>
</section>
...
<style lang="scss">
	hr {
		...
		background: linear-gradient(
			90deg,
			rgba(var(--hr-color-rgb), 0) 0%,
			rgba(var(--hr-color-rgb), 1) 50%,
			rgba(var(--hr-color-rgb), 0) 100%
		);
		inline-size: 100%;
		margin-inline: 0;
